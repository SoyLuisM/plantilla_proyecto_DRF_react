"""
Django settings for my_login_api project.
...
ALLOWED_HOSTS = list(os.getenv('DJANGO_ALOWED_HOST').split(","))
...
ROOT_URLCONF = 'my_login_api.urls'
...
WSGI_APPLICATION = 'my_login_api.wsgi.application'
